...
(() => {
    ...
    if (!apiKey) {
        status.hidden = false;
        status.textContent = "Doplnte window.MAPA_CONFIG.apiKey v mapa.html.";
        return;
    }
    ...
    script.onerror = () => {
        status.hidden = false;
        status.textContent = "Mapa sa nepodarilo nacitat. Skontrolujte API kluc a Maps JavaScript API.";
    };
